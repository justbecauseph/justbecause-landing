    ...
    <header className="bg-gray-900 text-white py-4 px-6">
      <div className="container mx-auto flex justify-between items-center">
        <div className="flex space-x-4">
          ...
          <a href="tel:+639171234567" className="hidden md:flex items-center hover:text-blue-400 transition">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-1" viewBox="0 0 20 20" fill="currentColor">
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-gray-800 absolute top-full left-0 w-full z-50">
          ...
          <div className="pt-4 mt-4 border-t border-gray-700">
            ...
            <a href="tel:+639171234567" className="flex items-center py-2 hover:text-blue-400 transition">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
                <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
              </svg>
              +63 917 123 4567
