...
const ServiceCard: React.FC<ServiceCardProps> = ({ title, description, icon, index = 0 }) => {
  return (
    <div
      className="group relative bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur-xl rounded-2xl border border-white/10 hover:border-white/20 transition-all duration-500 p-8 hover:bg-gradient-to-br hover:from-white/10 hover:to-white/[0.05] overflow-hidden"
    ...
    >
      ...
      <div className="relative z-10">
        <div className="relative mb-6">
          ...
          <div className="relative w-16 h-16 bg-gradient-to-br from-white/10 to-white/5 rounded-2xl flex items-center justify-center border border-white/10 group-hover:border-white/20 group-hover:scale-110 transition-all duration-500">
